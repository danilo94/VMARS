 ...
 */
    ...
    */
       ...
       public static KeywordMap getKeywords()
      {
         ...
         // add Coprocessor 1 (floating point) register file
            mars.vmips.hardware.VectorRegister[] vectorMipsRegisterFile = mars.vmips.hardware.VectorMips.getRegisters();
            for (int i=0; i< vectorMipsRegisterFile.length; i++) {
               cKeywords.add( vectorMipsRegisterFile[i].getName(), Token.KEYWORD3 );
            }  
